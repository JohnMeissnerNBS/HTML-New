...
* sometimes preceding a variable is an underscore _ or dollar sign $

> Data Types
* Two types of types
* primatives and objects

* objects have the object datatype
...
let myBigInt = 99999999999999n; //? this is a numeric literal
console.log(myBigInt);

let myBrokenBigInt = 99999999999999999;
...
*nulll is empty and undefined has now been initialised (no real value)
...
let testString = "check $(stringTwo)"
